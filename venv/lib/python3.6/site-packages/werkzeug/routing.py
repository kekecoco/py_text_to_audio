...
"""
    ...
    When it comes to combining multiple controller or templates functions (however
...
class MapAdapter(object):
    ...
    def dispatch(self, view_func, path_info=None, method=None,
        ...
        the endpoint and a dict with the values for the templates.  It should
        look up the templates function, call it, and return a response object
        ...
        :param view_func: a function that is called with the endpoint as
                          ...
                          to dispatch to the actual templates function with this
